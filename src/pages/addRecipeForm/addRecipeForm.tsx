...
export function AddRecipePage() {
   ...
   */
  function IngredientListBuilder(
    ingredients: { ingredientId: string; quantity: number }[]
  ) {
    let ingredientList = ingredients.map((item) => {
      let ingredient = storeIngredients.find(
  ...
  return (
    <Flex align="center" justify="center">
      <Box
        ...
        p={6}
        rounded="md"
        minW={{ base: 200, sm: 300, md: 440, lg: 700 }}
        mx={"auto"}
      >
        <Formik
            ...
            <Form onSubmit={handleSubmit}>
              <VStack spacing={4} align="flex-start">
                <Flex
                  ...
                  w={"full"}
                >
                  <RecipeInfoSection errors={errors} touched={touched} />
                </Flex>
                <Flex gap={4}>
                ...
                <FormControl
                  isInvalid={
                    !!errors.instructions &&
                    (touched.instructions as boolean | undefined)
                  }
                >
                ...
                <IngredientsSection errors={errors} touched={touched} />
...
// Receives errors and touched from Formik as props
const RecipeInfoSection = ({
  ...
  return (
    <>
      <VStack spacing={4} align="flex-start" flexGrow={2}>
...
const IngredientsSection = ({
  ...
  function validateIngredients(
    ...
    if (ingredients.length === 0) {
      ...
      ingredients.some((ingredient) => ingredient.ingredientId === "")
    ) {
  ...
  return (
    <FormControl
      isInvalid={
        !!errors.ingredients && (touched.ingredients as boolean | undefined)
      }
    >
      ...
      />
      <FormErrorMessage>
        {errors.ingredients as string | undefined}
      </FormErrorMessage>
    </FormControl>
  );
};
