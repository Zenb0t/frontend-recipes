...
//             let value = { ingredientId: item.ingredient._id, quantity: item.quantity };
//             return value;
//         });
...
//         if (ingredientList.some((item) => item.ingredient._id === ingredient._id)) {
//             console.log("Ingredient already in the list"); //TODO: Replace with toast?
//             return;
//         }
//         const newIngredient: IngredientItem = { ingredient: ingredient, quantity: quantity, measuringUnit: ingredient.measuringUnit };
...
//         const newIngredientList = ingredientList.filter((item) => item.ingredient._id !== ingredient._id);
//         setIngredientList(newIngredientList);
//         handleAddToIdList(newIngredientList);
//     };
...
//                     </Flex>
//                     {ingredientList.some((item) => item.ingredient._id === props.ing.id) ?
//                         <Flex ml='auto'>
...
//                     <AddedIngredientItem key={item.ingredient._id} item={item} />
//                 ))}
//             </Stack>
//         </Flex>
//     );
